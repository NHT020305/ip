...
public class Ui {
     ...
     */
    public void welcome() {
        System.out.println(" Welcome to PETER chatbot!");
    ...
    public void instruction() {
        ...
        System.out.println("    \"find <keyword>\": list all the tasks matching that keyword.");
        System.out.println("    \"bye\": exit Peter chatbot.");
     ...
     */
    public void goodbye() {
        System.out.println(" Bye. PETER chatbot hopes to see you again soon!");
    }

    /**
     * Displays an empty line separate sections in the console output.
     */
    public void space() {
        System.out.println();
    }
